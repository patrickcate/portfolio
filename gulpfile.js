...
gulp.task('sass', function() {
  return sass('sass/**/*.scss', {
    ...
    .pipe(
      prefix({
        browsers: ['last 6 Chrome versions', 'last 6 Firefox versions', 'last 4 iOS versions', 'last 4 Safari versions', 'Explorer >= 9', 'last 5 Opera versions', 'Android >= 4'],
        cascade: false,
      })
    )
    .pipe(gulp.dest('css'))
...
gulp.task('js', function() {
  gulp
    .src('./js/build/require-lightbox.js')
    .pipe(rename('lightbox.js'))
    .pipe(gulp.dest('./js'));
  gulp
    .src('./js/build/require-form.js')
    .pipe(rename('forms.js'))
    .pipe(gulp.dest('./js'));
  gulp
    .src(['./js/build/main.js', './js/src/require.min.js'])
    .pipe(gulp.dest('./js'))
    .pipe(
      browserSync.reload({
        stream: true,
...
gulp.task('svg-sprite', function() {
  gulp
    .src(['./_source/assets/svg-sprite-icons/base/*.svg', './_source/assets/svg-sprite-icons/about/*.svg'])
    .pipe(svgmin())
    .pipe(
      svgstore({
        inlineSvg: false,
  ...
  gulp
    .src(['./_source/assets/svg-sprite-icons/base/*.svg', './_source/assets/svg-sprite-icons/work/*.svg'])
    .pipe(svgmin())
    .pipe(
      svgstore({
        inlineSvg: false,
    ...
    .pipe(gulp.dest('./_includes/'));
  gulp
    .src(['./_source/assets/svg-sprite-icons/base/*.svg', './_source/assets/svg-sprite-icons/contact/*.svg'])
    .pipe(svgmin())
    .pipe(
      svgstore({
        inlineSvg: false,
